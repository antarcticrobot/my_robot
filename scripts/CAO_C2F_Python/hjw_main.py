...
class Registration:
    ...
    def prepare_and_get_affmat(self):
        # %%
        # section 1: Read source images
        # 这里省略了张正友畸变校正法，去除红外图片的畸变
        I1_rgb, I1_gray, I2_rgb, I2_gray = readimage(
            path_infrared, self.img_infrared, path_visible, self.img_visible)
        ...
        return I1_rgb, I1_gray, I2_rgb, I2_gray, affmat

    def compute_get_result(self, I1_rgb, I1_gray, I2_rgb, I2_gray, affmat):
...
if __name__ == '__main__':
    args1 = 'I1.jpg'
    args2 = 'V1.jpg'
    r = Registration(args1, args2)
    I1_rgb, I1_gray, I2_rgb, I2_gray, affmat = r.prepare_and_get_affmat()
    r.compute_get_result(I1_rgb, I1_gray, I2_rgb, I2_gray, affmat)
